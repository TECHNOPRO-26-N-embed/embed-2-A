...
| F01 | ランダム音再生 | playRandomTone() | ランダムな音を鳴らす | なし | なし | loop()内 |
| F02 | 音程調整 | adjustTone() | ジョイスティック上下で音程調整 | なし | なし | loop()内 |
| F03 | 音長調整 | adjustLength() | ジョイスティック左右で音長調整 | なし | なし | loop()内 |
